...
import com.kh.final3.chatting.model.service.ChatService;
...
public class ChatController {
    ...
    public String createChat(ChatRoom room, String userName, String userEmail, String masterNickname){
        ...
        //Coustom m = pService.getProductDetail(masterNickname);
        Member m = (Member) cuds.loadUserByUsername(masterNickname);
    	
    	
        room.setUserEmail(userEmail);
        room.setUserName(userName);
        room.setMasterEmail(m.getEmail());
        room.setMasterName(m.getUserName());
        room.setMasterPic(m.getAuth());
