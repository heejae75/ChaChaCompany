...
<script>
	$(function(){
				...
				addEventButton : {
					...
					click : function(e){
						$("#schedule-modal").modal("show");
							...
							var $startDate = $("#startDate").val(todayString);  
		...
		$("#change-schedule").on("click", function(){
			...
			}else if($("#schedule-category").val()=='AS'){
